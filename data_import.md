...
A useful function to pull up the entire dataset in a new window, not
output:
...
‘skimr’ tells you how many rows, columns, how many character vs. numeric
vs. factors, how many variables are complete or missing rate, min and
max group size, how many unique values, prints histogram of numeric
variables and basic descriptive stats
